    ...
    <section id='about' className="bg-[#111111] flex flex-col items-center w-full">
        <div className="flex flex-col items-center max-w-[1440px] px-8 md:px-16">
            ...
            <div className='flex flex-col md:flex-row items-center gap-12 mt-14'>
                <img src={Foto_perfil} alt="Imagem Autor" className='bg-cover w-72' />
                ...
                Tenho grande interesse na área de análise de dados e pretendo me aprofundar em Python no futuro, com o objetivo de me tornar um desenvolvedor Full Stack. Sou motivado por desafios, proativo e tenho um forte compromisso com a aprendizagem contínua. Tenho como meta contribuir para a inovação em equipe e impactar positivamente o ambiente de trabalho, ao mesmo tempo em que continuo a desenvolver minhas habilidades técnicas e interpessoais. <br />
