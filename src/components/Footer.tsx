    ...
    <footer className='bg-black w-full md:px-12 px-6 py-8'>
        <div className='flex justify-between items-center max-w-[1440px]'>
            <ul className='flex items-center gap-4 md:gap-6'>
                <li>
                  <a href="mailto:leonardogarcia1914@hotmail.com">
                    <i className="fas fa-envelope md:text-3xl text-2xl text-zinc-400 transform transition-transform duration-200 hover:scale-125" ></i>
                  </a>                 
                </li>
                <li>
                  <a href="https://www.linkedin.com/in/leonardo-garcia-21a2852b0/" target='_blank' rel="noopener">
                ...
                <li>
                  <a href="https://github.com/leogarcia2004" target='_blank' rel="noopener">
                ...
                <li>
                  <a href="https://wa.me/5516992278054" target="_blank" rel="noopener" >
